...
# Initial setup for Dynamic Identities , 160 bit address for communication , 4-qubit Bell States , chaincode , etc. 
We employed Bionic 18.04.4, Pandas, Python 3.6, Jupyter Notebook, and Hyperledger AnonCreds 1.0 to create and confirm Dynamic Identities (DID), 160-bit addresses, and Fidelity varification for Healthcare CHoT  participants. AnonCreds 1.0 operates with the Hyperledger Indy platform to generate an Indy System Pool, assigning verifier roles like Trust Anchor (role '101') or Trustee (role '0') using Nym Transactions in our main21.py program.
